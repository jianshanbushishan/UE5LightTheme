...
ULightThemeFixSettings::ULightThemeFixSettings()
	...
	, bFixDetailsPanelText(true)
	, bFixPIEActorLabels(true)
	, bFixLiveCodingDialog(true)
	...
	, PIEActorLabelColor(FromSrgb(0x7A, 0x50, 0x00))
	, LiveCodingDialogBackgroundColor(FromSrgb(0xF2, 0xF4, 0xF7))
	, LiveCodingDialogTextColor(FromSrgb(0x22, 0x27, 0x2B))
	, LiveCodingDialogCornerRadius(6.0f)
